...
import {ADD_TO_CART, RETURN_PRODUCT_FROM_CART} from './consts';
...
export const productsReducer = produce((draft, action) => {
    ...
    switch (type) {
        ...
        case RETURN_PRODUCT_FROM_CART:  draft.forEach(product => {if (product.productName === payload.productName) product.productQuantity = product.productQuantity+payload.productQuantity}); return draft;
